<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="{{ url('cart') }}" class="btn shadow my-2 my-sm-0 btn-danger text-shadow" id="cart-btn"
            style="font-size: 14px;"><i class="fas fa-shopping-cart"></i> Cart: <cart-total-component>
            </cart-total-component> {{ config('app.currency') }}</a>
    </div>
</nav>

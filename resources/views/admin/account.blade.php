        ...
        <div id="page-content-wrapper">
            ...
            <div class="container mt-5">
                    ...
                    <div class="card-body">
                        <form action="{{ url('name/update') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="submit" id="changeNameBtn" class="btn btn-primary float-right"
                    ...
                    <div class="card-body">
                        <form action="{{ url('username/update') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="submit" id="changeUsernameBtn" class="btn btn-primary float-right"
                                        disabled="disabled">Change</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card-body">
                        <form action="{{ url('password/update') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-6"><input type="password" name="current_password"
                                                id="current_password" class="form-control w-100" required
                                                placeholder="Current Password"></div>
                                        <div class="col-md-6"><input type="password" name="new_password" id="new_password"
                                                class="form-control w-100" required placeholder="New Password"></div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-outline-danger text-center mt-5" data-toggle="modal"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="deleteModalTitle"> <i
                                        class="fas fa-exclamation-triangle text-warning"></i> Are you sure ?</h5>

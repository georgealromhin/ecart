        ...
        <div id="page-content-wrapper">
            ...
            <div class="container mt-5">
                ...
                @if(Auth::user()->role == 'main')
                    <div class="row">
                        <div class="col-md-6">
                            <h3> <i class="fas fa-users-cog"></i> User Manager</h3>
                        </div>
                        <div class="col-md-6"><a href="user" class="btn btn-primary btn-sm float-right"> <i
                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        @if($user->role != 'main')
                                            <a href="#" class="text-danger" onclick="deleteUser({{ $user->id }})"> <i

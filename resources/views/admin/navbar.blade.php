            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light shadow dropdown-menu-right" aria-labelledby="navbarDropdown2">
                        @foreach(Auth::user() ->notifications as
                            $notification)
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light shadow dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="{{ url('user_manager') }}"> <i class="fas fa-users-cog"></i> User
                            Manager</a>

                        <a class="dropdown-item" href="{{ url('account') }}"> <i class="fas fa-user-cog"></i> Your
                            Account</a>

                        <div class="dropdown-divider"></div>

                        <a class="dropdown-item" href="{{ url('user/logout') }}"><i class="fas fa-sign-out-alt"></i>
                            Logout</a>

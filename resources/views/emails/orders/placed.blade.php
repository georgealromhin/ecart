@component('mail::message')
    ...
    <p>Order №{!! $data->order_number !!} on the site {!! url('/') !!}. the Total cost of the order is <b>{!! $data->total
            !!} {!! config('app.currency') !!}</b></p>
    ...
    <table>
        @foreach($data->order_details as $item)
            <tr>
                <td><img src="{!!  url($item->products->image) !!}" alt="img"
                        style="object-fit: cover;width: 50px;height: 50px;border-radius: 25px;"> </td>

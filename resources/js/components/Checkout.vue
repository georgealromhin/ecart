  ...
  <div>
    ...
    <b-card header="Checkout" header-tag="header" class="shadow-sm" v-if="!checkout">
      <b-form @submit="onSubmit">
        ...
        <b-form-group id="input-group-3" label="Phone (Optional)" label-for="input-3">
          <b-form-input
            id="input-3"
            class="shadow-sm"
            v-model="form.phone"
        ...
        <b-form-group
          ...
          label-for="input-5"
          v-if="form.selected == 'Delivery'"
        >
          <b-form-textarea
            id="input-5"
            class="shadow-sm"
            v-model="form.delivery_address"
            :required="form.selected == 'Delivery' ? true : false"
          ></b-form-textarea>
        </b-form-group>
        ...
        <b-row>
          <b-col></b-col>
          <b-col>
            <b-button type="submit" variant="danger" class="w-100 float-right shadow-sm">Submit</b-button>
          </b-col>
        </b-row>
      </b-form>
    </b-card>
